...
DEFAULT_PATHS = {
    ...
    "GENE_DICT_PATH": "/cpfs01/projects-HDD/cfff-c7cd658afc74_HDD/public/BrainST_pretrain/model_h5ad_1211.h5ad",
    "GENE_LOOKUP_DIR": "/need_file_path/prior_knowledge/gene_lookup",
    "ESM_EMBED_PATH": "/cpfs01/projects-HDD/cfff-c7cd658afc74_HDD/public/BrainST_pretrain/esm2_embeddings_d5120.pt",
}

def resolve_path(key: str, path_dict: Optional[dict] = None) -> str:
    """
