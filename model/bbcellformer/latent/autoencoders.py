...
class GMVAELatentLayer(nn.Module):
    ...
    def gaussian_loss(self, z, z_mu, z_var, z_mu_prior, z_var_prior):
        ...
        Args:
           ...
           z_mu: (array) array containing the mean of the inference model_raw
           z_var: (array) array containing the variance of the inference model_raw
           z_mu_prior: (array) array containing the prior mean of the generative model_raw
